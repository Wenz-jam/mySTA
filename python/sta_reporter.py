...
from sta_difftest.formatters import print_check_report, print_csv_report
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Report STA slack difftest summary.")
    ...
    parser.add_argument("--format", choices=["csv", "text"], default="csv", help="Output format.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"sta_reporter: {err}", file=sys.stderr)
        return 2
    ...
    if args.format == "text":
        ...
        print_csv_report(result, timings=dut_timings)
    return 0
